...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTABELECIMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTABELECIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTABELECIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTABELECIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTABELECIMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTABELECIMENTO actions', async () => {
      const expectedActions = [
        {
